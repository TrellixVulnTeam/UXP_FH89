...
template bool
js::GetPrefixInteger(JSContext* cx, const Latin1Char* start, const Latin1Char* end, int base,
...
bool
js::GetDecimalNonInteger(JSContext* cx, const char16_t* start, const char16_t* end, double* dp)
{
    MOZ_ASSERT(start <= end);
